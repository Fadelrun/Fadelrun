...
4. [Калькулятор на TypeScript и React](https://github.com/Fadelrun/Calculator)  
...
5. [Лендинг на SCSS](https://github.com/Fadelrun/LandingPage)  
...
6. [Сервис по распознаванию речи с использованием WebSpeech API](https://github.com/Fadelrun/Speech-Recogniton-Service)  
   Веб-приложение для распознавания речи с использованием веб-API для захвата звука и преобразования речи в текст. 

7. [Игра 'Убей дракона'](https://github.com/Fadelrun/DragonGame)  
...
8. [Weather App](https://github.com/Fadelrun/WeatherApp)  
